...
- **默认策略**：竖向拼接默认“最小宽”，横向拼接默认“最小高”，拼接间距默认 0
- **设计目标**：在保证清晰度的同时，尽可能降低大图/多图带来的内存峰值，避免卡顿与闪退
...
- 由于不同机型对 Canvas/图片解码的上限差异较大，建议在 iOS 与 Android 真机分别测试：
  - 多图（接近 12 张）+ 大图（总容量较大）的加载与拼接
  - 拼接清晰度与导出成功率
